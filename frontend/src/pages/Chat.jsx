...
Clear Conversation
     ...
     <Box  sx={{display: "flex", flex: {md:0.8, xs:1, sm:1},  flexDirection:"column", px:3}}> 
      ...
      <Box sx={{width: "100%", heigth: "60vh", borderRadius:3, mx: 'auto', display:'flex',flexDirection:"column", overflow:"scroll", overflowX:'hidden', overflowY: "auto",scrollBehavior:"smooth"}}>
      { chats.map((chat)=>{
       return <Chatitem content={chat.content} role={chat.role} />
      })}
      </Box>
